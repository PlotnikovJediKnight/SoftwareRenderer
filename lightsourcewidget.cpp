...
namespace pv {
    ...
    LightSourceWidget::LightSourceWidget(LightSource* light, QWidget *parent) :
        ...
        ui_->lightItemPowerValue->setText(QString::number(light->GetReflectancePower()));
        ui_->lightItemPowerSlider->setValue(light->GetReflectancePower());
    ...
    void LightSourceWidget::UpdateLightSourcePower(int newValue) {
        light_source_->SetReflectancePower(newValue);
    }
